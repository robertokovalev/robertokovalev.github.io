...
lib.ssMetadata = [
		{name:"vision_atlas_", frames: [[0,844,2217,842],[0,0,2217,842]]}
];
...
(lib.bullet = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0,0.1,0.658,0.633,0,0,0,5.2,5.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:6,regY:6,scaleX:0.69,scaleY:0.67,x:0.6,y:0.6,alpha:0.958},0).wait(1).to({scaleX:0.73,scaleY:0.71,y:0.7,alpha:0.917},0).wait(1).to({scaleX:0.76,scaleY:0.74,alpha:0.875},0).wait(1).to({scaleX:0.79,scaleY:0.78,alpha:0.833},0).wait(1).to({scaleX:0.83,scaleY:0.81,x:0.7,alpha:0.792},0).wait(1).to({scaleX:0.86,scaleY:0.85,y:0.8,alpha:0.75},0).wait(1).to({scaleX:0.89,scaleY:0.88,alpha:0.708},0).wait(1).to({scaleX:0.93,scaleY:0.92,alpha:0.667},0).wait(1).to({scaleX:0.96,scaleY:0.96,x:0.8,y:0.9,alpha:0.625},0).wait(1).to({scaleX:1,scaleY:0.99,alpha:0.583},0).wait(1).to({scaleX:1.03,scaleY:1.03,alpha:0.542},0).wait(1).to({scaleX:1.06,scaleY:1.06,x:0.9,y:1,alpha:0.5},0).wait(1).to({scaleX:1.1,scaleY:1.1,alpha:0.458},0).wait(1).to({scaleX:1.13,scaleY:1.13,alpha:0.417},0).wait(1).to({scaleX:1.16,scaleY:1.17,alpha:0.375},0).wait(1).to({scaleX:1.2,scaleY:1.21,x:1,y:1.1,alpha:0.333},0).wait(1).to({scaleX:1.23,scaleY:1.24,alpha:0.292},0).wait(1).to({scaleX:1.26,scaleY:1.28,alpha:0.25},0).wait(1).to({scaleX:1.3,scaleY:1.31,y:1.2,alpha:0.208},0).wait(1).to({scaleX:1.33,scaleY:1.35,x:1.1,alpha:0.167},0).wait(1).to({scaleX:1.37,scaleY:1.38,alpha:0.125},0).wait(1).to({scaleX:1.4,scaleY:1.42,alpha:0.083},0).wait(1).to({scaleX:1.43,scaleY:1.46,y:1.3,alpha:0.042},0).wait(1).to({scaleX:1.47,scaleY:1.49,x:1.2,alpha:0},0).wait(1));
...
(lib.vision = function(mode,startPosition,loop) {
	...
	this.instance_11.setTransform(0,86,0.462,0.462);

	this.instance_12 = new lib.vision_2x();
	this.instance_12.parent = this;
	this.instance_12.setTransform(0,86,0.462,0.462);
